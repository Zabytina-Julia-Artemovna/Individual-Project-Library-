...
#include "book.h"
Book::Book(int count, int year_of_publication, int id, std::string title, std::string author,
...
Book::Book(const Book& other_book) noexcept : _count(other_book._count), 
_year_of_publication(other_book._year_of_publication), _id(other_book._id),
_title(other_book._title), _author(other_book._author), 
_publishing_house(other_book._publishing_house),
